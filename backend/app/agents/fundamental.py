"""Fundamental analyst — produces a `FundamentalOutput` from `AnalysisData`."""
from __future__ import annotations

from app.agents.base import AgentRun, BaseAgent
from app.schemas.data import AnalysisData
from app.schemas.outputs import FundamentalOutput
...
class FundamentalAgent(BaseAgent):
    ...
    system_prompt_path = "system/fundamental.md"
    methodology_paths = ("methodology/valuation.md", "methodology/citations.md")
