"""Technical analyst — produces a `TechnicalOutput` from `AnalysisData`."""
from __future__ import annotations

from app.agents.base import AgentRun, BaseAgent, OnStep
from app.schemas.data import AnalysisData
from app.schemas.outputs import TechnicalOutput
...
class TechnicalAgent(BaseAgent):
    ...
    system_prompt_path = "system/technical.md"
    methodology_paths = ("methodology/technical.md", "methodology/citations.md")
